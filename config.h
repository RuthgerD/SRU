constexpr auto SRU_SCHEMA = R"({
    ...
    "properties": {
        "qpdf_bin": {
            "$id": "#/properties/qpdf_bin",
            "type": "string",
            "title": "The qpdf_bin Schema",
            "minLength": 1
        },
        "dcmtk_bin": {
            "$id": "#/properties/dcmtk_bin",
            "type": "string",
            "title": "The dcmtk_bin Schema"
        },
		"dcmtk_company": {
		  "$id": "#/properties/dcmtk_company",
		  "type": "string",
		  "title": "The dcmtk_company Schema",
		  "minLength": 1
		},
		"dcmtk_device": {
		  "$id": "#/properties/dcmtk_device",
		  "type": "string",
		  "title": "The dcmtk_device Schema",
		  "minLength": 1
		},
        "dcmtk_name_obj": {
            "$id": "#/properties/dcmtk_name_obj",
            "type": "integer",
            "title": "The dcmtk_name_obj Schema",
            "minimum": 0
        },
        "dcmtk_surname_obj": {
            "$id": "#/properties/dcmtk_surname_obj",
            "type": "integer",
            "title": "The dcmtk_surname_obj Schema",
            "minimum": 0
        },
        "dcmtk_id_obj": {
            "$id": "#/properties/dcmtk_id_obj",
            "type": "integer",
            "title": "The dcmtk_id_obj Schema",
            "minimum": 0
        },
        "dcmtk_birth_obj": {
            "$id": "#/properties/dcmtk_birth_obj",
            "type": "integer",
            "title": "The dcmtk_birth_obj Schema",
            "minimum": 0
        },
        "dcmtk_sex_obj": {
            "$id": "#/properties/dcmtk_sex_obj",
            "type": "integer",
            "title": "The dcmtk_sex_obj Schema",
            "minimum": 0
        },
        "import_path": {
            "$id": "#/properties/import_path",
            "type": "string",
            "title": "The import_path Schema",
            "minLength": 1
        },
        "date_provider": {
