...
static constexpr auto default_obj_match_key =
    R"((?:([\d.]*) ([\d.]*) ([\d.]*) rg\n)|(?:BT\n/F(\d+) ([\d.]+) Tf\n([^\n]*) ([\d.]*) ([\d.]*) Tm\n\(([^\n]*)\)Tj\nET))";
static constexpr auto default_obj_match = ctll::fixed_string{
    R"((?:([\d.]*) ([\d.]*) ([\d.]*) rg\n)|(?:BT\n/F(\d+) ([\d.]+) Tf\n([^\n]*) ([\d.]*) ([\d.]*) Tm\n\(([^\n]*)\)Tj\nET))"};
...
class ReAccel {
    ...
    static constexpr std::tuple ctre_regexs = {
        std::pair{default_obj_match_key,
                  [](std::string_view sv) {
                      return ctre::range<default_obj_match>(sv);
                  }},
        std::pair{PAGE_EXAMPLE_obj_match_key,
                  [](std::string_view sv) {
    ...
    static auto match2vec(Match match) -> std::vector<std::string> {
